...
stdyn_diffAN_sim2_min_ga_indx=find (stdyn_diffAN_sim2(:,POSITION) == min(stdyn_diffAN_sim2(:,POSITION)));
best_genome=stdyn_diffAN_sim2_values(stdyn_diffAN_sim2_min_ga_indx(1),:);
diffx = targetparameters-best_genome';
stdyn_diffAN_sim2_min_ga=-diffx./targetparameters;
stdyn_diffAN_sim3_min_ga_indx=find (stdyn_diffAN_sim3(:,POSITION) == min(stdyn_diffAN_sim3(:,POSITION)));
best_genome = stdyn_diffAN_sim3_values(stdyn_diffAN_sim3_min_ga_indx(1),:);
diffx = targetparameters-best_genome';
stdyn_diffAN_sim3_min_ga=-diffx./targetparameters;
...
ifrga25_diffAN_sim2_min_ga_indx=find (ifrga25_diffAN_sim2(:,POSITION) == min(ifrga25_diffAN_sim2(:,POSITION)));
best_genome=ifrga25_diffAN_sim2_values(ifrga25_diffAN_sim2_min_ga_indx(1),:);
diffx = targetparameters-best_genome';
ifrga25_diffAN_sim2_min_ga=-diffx./targetparameters;
ifrga25_diffAN_sim3_min_ga_indx=find (ifrga25_diffAN_sim3(:,POSITION) == min(ifrga25_diffAN_sim3(:,POSITION)));
best_genome = ifrga25_diffAN_sim3_values(ifrga25_diffAN_sim3_min_ga_indx(1),:);
diffx = targetparameters-best_genome';
ifrga25_diffAN_sim3_min_ga=-diffx./targetparameters;
...
ivga25_diffAN_sim2_min_ga_indx=find (ivga25_diffAN_sim2(:,POSITION) == min(ivga25_diffAN_sim2(:,POSITION)));
best_genome=ivga25_diffAN_sim2_values(ivga25_diffAN_sim2_min_ga_indx(1),:);
diffx = targetparameters-best_genome';
ivga25_diffAN_sim2_min_ga=-diffx./targetparameters;
ivga25_diffAN_sim3_min_ga_indx=find (ivga25_diffAN_sim3(:,POSITION) == min(ivga25_diffAN_sim3(:,POSITION)));
best_genome = ivga25_diffAN_sim3_values(ivga25_diffAN_sim3_min_ga_indx(1),:);
diffx = targetparameters-best_genome';
ivga25_diffAN_sim3_min_ga=-diffx./targetparameters;
