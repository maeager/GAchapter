\section{Optimisation of {BNN}s using Ideal inputs \textbf{OR} Expanded results}\label{sec:GA:ResultsIdeal}
...
\subsection{Cross comparison of best genomes}\label{sec:GA:Ideal-Xcomp-best}
