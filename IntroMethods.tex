...
modeling \gls{BNN}s is becoming more
...
Hodgkin-Huxley model.)  To develop larger {\BNN}s, with complex network
...
\caption{(A) Stellate microcircuit showing synaptic interaction within
  ...
  cells of the dorsal CN\@. Excitatory synapses from {\ANF}s (arrows) are
