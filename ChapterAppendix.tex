...
\section{Chapter 5 Appendix}\label{sec:GA:chapter-5-appendix}
...
%    step and 5 step parameter variation population.}\label{tab:5}
...
% \hline
%                         & \multicolumn{2}{c}{ST}  & \multicolumn{2}{c}{IFR-25} & \multicolumn{2}{c}{IFR-250} & \multicolumn{2}{c}{AIV-25} & \multicolumn{2}{c}{AIV-250} \\
% \hline
