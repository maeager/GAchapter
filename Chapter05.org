...
more compact, Figure 6B. 
#\yellownote{linkback to previous  section}. 
This meant that there was less difference between a good
...
These cases were classified variously as
...
real  network weights.  A Gaussian weight distribution is
