...
Hybrid techniques may be advantageous considering network structure and synaptic
weights may not be well suited to the same optimisation method
...
problem of constraining \BNNs.   Optimising spiking neural networks to an exact solution
relies on analytically differentiable neural models and synapses
\citep{BretteGuigon:2003,Brette:2006}, and other analytical methods have been reviewed \citep{Brette:2007,EggertHemmen:2001}.
 Alternative methods to infer connectivity and
