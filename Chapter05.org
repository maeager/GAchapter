...
reproduces the target data. We assessed three alternate cost functions derived,
...
As described in Chapter \ref{sec:Chapter1} The \CN is the
...
parameter spaces within a noisy fitness environment. \yellownote{References required in this paragraph}
