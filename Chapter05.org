...
\end{equation}
\noindent where $c_{i}$ is the genome's cost function score, and $\mathbf{c}$ is
...
** \textsf{cnstellate} NEURON model of HH-like neurons in the cochlear nucleus
...
#+include:  ../../soma/modfiles/rm_vect.mod src c
...
#+include:  ../../soma/modfiles/klt.mod src c
...
#+include:  ../../soma/modfiles/ka.mod  src c

*** Auditory nerve fibre NMODL interface

\begin{lstlisting}[label=lbl:arlo,caption=\mbox{\textsf{an\_arlo.mod}} contains the NMODL interface to the ARLO auditory nerve model \citep{HeinzZhangEtAl:2001}.] \end{lstlisting}
#+include:  ../../soma/modfiles/an_arlo.mod src c


*** Hoc files

\begin{lstlisting}[label=lbl:amd,caption=\mbox{\textsf{opt4/opt4amd.hoc}} is the main file called by the GA slave program to evaluate the cost function scores. This file creates CN network model and runs the notch noise stimulus through the model and calculates the cost function scores relative to the target network.] \end{lstlisting}
#+include:  ../../soma/opt4/opt4amd.hoc src octave



** \textsf{ganeuron}

\begin{lstlisting}[label=lbl:genomeH,caption=\mbox{\textsf{genome.h}} contains global variables shared by master and slave programs.] \end{lstlisting}
#+include:  ../../soma/ganeuron/opt4/genome.h src c++
...
#+include:  ../../soma/ganeuron/opt4/genome.c src c++
...
#+include:  ../../soma/ganeuron/opt4/packgenomes.sh src sh
